...
class CEconItemPreviewDataBlock extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \CEconItemPreviewDataBlock\Sticker[]|\Google\Protobuf\Internal\RepeatedField $stickers
     *     @type int $inventory
     *     @type int $origin
     *     @type int $questid
     *     @type int $dropreason
    ...
    /**
     * Generated from protobuf field <code>repeated .CEconItemPreviewDataBlock.Sticker stickers = 12;</code>
     * @param \CEconItemPreviewDataBlock\Sticker[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setStickers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \CEconItemPreviewDataBlock\Sticker::class);
        $this->stickers = $arr;
